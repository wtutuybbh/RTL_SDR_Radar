...
const quint32 DEFAULT_CACHE_DAYS = 700;
...
//private slot
QPixmap MapTileSource::startTileRequest(quint32 x, quint32 y, quint8 z)
{
 QPixmap tile;
...
//    emit tileRetrieved(x,y,z);

    image = getFinishedTile(x,y,z);
